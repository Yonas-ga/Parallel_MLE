...
std::pair<Vector, bool> gradient_ascent_gpu(Vector& theta, Data_vect& data, int d, int p, bool verbose, int box_size, int blockSize, double step,  int max_iter, double eps){
    int N = data.size();
